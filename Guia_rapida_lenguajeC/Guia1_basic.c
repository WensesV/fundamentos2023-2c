...
(Para ello, se suele escribir el nombre_de_la_variable = x_valor, ejemplo: num1 = 14;)
...
Int num = 7;
printf("Texto a imprimir con la numero --- %d", numero);
...
Texto a imprimir con la numero --- 7
...
/*-----< Ejemplo 2 (Con varias variables en una línea) >-----*/
...
/*---< Operaciones Matemáticas / Algebraicas >---*/
