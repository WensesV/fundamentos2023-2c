...
2.2. No son los mismos objetos, uno es un numero entero y el otro es un caracter/letra. Tienen el mismo valor ya que q en la tabla ASCII tiene valor de 113, el cual es el mismo de la variable C
2.3. Pantalla
